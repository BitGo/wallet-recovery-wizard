...
import { Starknet } from '@bitgo-beta/sdk-coin-starknet';
...
sdk.register('kavacosmos', CosmosSharedCoin.createInstance);
sdk.register('tkavacosmos', CosmosSharedCoin.createInstance);
sdk.register('dydxcosmos', CosmosSharedCoin.createInstance);
sdk.register('tdydxcosmos', CosmosSharedCoin.createInstance);
