...
5.  The next field will be different based on coin type
    ...
    3. For Ethereum, ERC20 Token, and Avalanche C-Chain, Wallet Contract Address needs to be provided. This is the Eth or Axaxc address of the wallet contract. This is also the wallet's base address.
...
12. An API Key token from etherscan.com needs to be provided for certain recoveries.
  ...
  1. For UTXO based coins like Bitcoin, Litecoin, Dash, Zcash, Bitcoin Gold, and Bitcoin Cash, the key is from https://blockchair.com/.

  2. For Ethereum and ERC20 token, the key is from https://etherscan.io/.

  3. For Avalanche C-Chain, the key is from https://snowtrace.io/.
