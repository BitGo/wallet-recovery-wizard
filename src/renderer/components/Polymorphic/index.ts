...
export type ComponentPropsWithoutRef<TTag extends React.ElementType, TProps> = TProps &
  TagProps<TTag> &
...
export type ComponentPropsWithRef<TTag extends React.ElementType, TProps> = ComponentPropsWithoutRef<TTag, TProps> & {
  ref?: ForwardedRef<TTag>;
};

// Helper function to lookup the ref type of a component
export type ForwardedRef<TTag extends React.ElementType> = React.ForwardedRef<React.ElementRef<TTag>>;
...
) => <TTag extends TElementType = TDefaultTag>(props: ComponentPropsWithRef<TTag, TProps>) => React.ReactElement | null;
