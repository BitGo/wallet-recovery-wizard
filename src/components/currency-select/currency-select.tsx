...
function CurrencySelect({
  ...
  const itemRenderer = (item: IInstrumentItem, { handleClick, modifiers }) => {
    ...
    return (
      <MenuItem
        ...
        data-testid={`currency-select--${symbol.toLocaleLowerCase()}-item`}
  ...
  return (
    <CurrencySelectComponent
      ...
      noResults={<MenuItem disabled text="No coins match your query..." />}
      ...
      >
        {!activeItem?.bitgoInstrument && (
          <React.Fragment>
            ...
            <div data-testid="currency-select" className="flex-grow-1 silver">
              Select a currency
            </div>
          </React.Fragment>
        )}
