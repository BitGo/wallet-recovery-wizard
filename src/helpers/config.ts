...
export const allCoinMetas: Record<string, CoinMetadata> = {
  ...
  erc7984: {
    Title: 'ERC7984',
    Description: 'ERC-7984 Confidential Token',
    Icon: 'eth',
    value: 'erc7984',
    ApiKeyProvider: 'etherscan.io',
    minGasLimit: '500,000',
    defaultGasLimit: '800,000',
    defaultGasLimitNum: 800000,
    defaultMaxFeePerGas: 100,
    defaultMaxPriorityFeePerGas: 20,
    isTssSupported: false,
  },
  trx: {
    Title: 'TRX',
    Description: 'Tron',
  ...
  hterc7984: {
    Title: 'HTERC7984',
    Description: 'Hoodi Testnet ERC-7984 Confidential Token',
    Icon: 'eth',
    value: 'hterc7984',
    ApiKeyProvider: 'etherscan.io',
    minGasLimit: '500,000',
