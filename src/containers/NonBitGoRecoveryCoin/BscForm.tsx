...
export type BscFormProps = {
  onSubmit: (
    values: BscFormValues,
    formikHelpers: FormikHelpers<BscFormValues>
  ) => void | Promise<void>;
  coinName: string; // Add coinName as a required prop
};

type BscFormValues = Yup.Asserts<typeof validationSchema>;
export function BscForm({ onSubmit, coinName }: BscFormProps) {
  const formik = useFormik<BscFormValues>({
    onSubmit,
    initialValues: {
      apiKey: '',
      backupKey: '',
  ...
  return (
    <FormikProvider value={formik}>
      <Form>
        ...
        <div className="tw-mb-4">
          <FormikTextfield
            HelperText="The Bsc address of the wallet contract. This is also the wallet's base address."
        ...
        <div className="tw-mb-4">
          <FormikTextfield
            HelperText="An Api-Key Token from bscscan.com required for Bsc Mainnet recoveries."
            Label="API Key"
            name="apiKey"
            Width="fill"
          />
        ...
        <div className="tw-mb-4">
          <FormikTextfield
            HelperText="Gas limit for the Bsc transaction. The value should be between 30,000 and 20,000,000. The default is 500,000 units of gas."
            Label="Gas limit"
            name="gasLimit"
            Width="fill"
          />
        ...
        <div className="tw-mb-4">
          <FormikTextfield
            HelperText="Max fee per gas for the Bsc transaction. The default is 20 Gwei."
        ...
        <div className="tw-mb-4">
          <FormikTextfield
            HelperText='"Tip" to the Bsc miner. This is by default 10 Gwei.'
