...
export type DogecoinFormProps = {
  onSubmit: (
    values: DogecoinFormValues,
    formikHelpers: FormikHelpers<DogecoinFormValues>
  ) => void | Promise<void>;
};

type DogecoinFormValues = Yup.Asserts<typeof validationSchema>;

export function DogecoinForm({ onSubmit }: DogecoinFormProps) {
  const formik = useFormik<DogecoinFormValues>({
    onSubmit,
    initialValues: {
      apiKey: '',
      userKey: '',
