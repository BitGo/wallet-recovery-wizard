...
const TARGET_DIR = path_1.resolve(ROOT_DIR, 'src/components/CryptocurrencyIcon');
const TARGET_FILE = path_1.resolve(TARGET_DIR, "get-dynamic-icon.ts");
const ICON_SOURCE_DIR = path_1.resolve(ROOT_DIR, 'node_modules/cryptocurrency-icons/react');
const generateCurrencyIcons = () => {
    ...
    if (!fs_1.existsSync(ICON_SOURCE_DIR)) {
        ...
        console.log('Make sure cryptocurrency-icons package is installed correctly.');
        process.exit(1);
    }
